...
def conv3x3(in_planes, out_planes, stride=1, groups=1, dilation=1):
    ...
    kernel_width = 33
    return nn.Conv1d(in_planes, out_planes, kernel_size=kernel_width, stride=stride,
                     padding=(kernel_width - 1)//2, groups=groups, bias=False, dilation=dilation)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.inplanes = 64
        self.dilation = 1
        self.all_depthwise = all_depthwise
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False):
        ...
        layers.append(block(self.inplanes, planes, stride, downsample, self.groups,
                            ...
                            all_depthwise=self.all_depthwise))
        self.inplanes = planes * block.expansion
        for _ in range(1, blocks):
            layers.append(block(self.inplanes, planes, groups=self.groups,
                                base_width=self.base_width, dilation=self.dilation,
                                norm_layer=norm_layer, all_depthwise=self.all_depthwise))
